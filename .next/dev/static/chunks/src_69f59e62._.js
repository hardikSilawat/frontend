...
"[project]/src/services/dsaService.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
function DSAPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DSAPage.useEffect": ()=>{
            const fetchData = {
                "DSAPage.useEffect.fetchData": async ()=>{
                    try {
                        setLoading(true);
                        ...
                        setCompletedSubtopicIds(completedRes.data?.map({
                            "DSAPage.useEffect.fetchData": (item)=>item._id
                        }["DSAPage.useEffect.fetchData"]) || []);
...
//# sourceMappingURL=src_69f59e62._.js.map