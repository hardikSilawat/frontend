...
function InnerClientProviders({ children }) {
    ...
    const checkToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "InnerClientProviders.useCallback[checkToken]": async ()=>{
            ...
            // If no token and on a protected route, redirect to appropriate login
            if (!token) {
                if (isAdminRoute && !pathname.startsWith("/admin/login")) {
                    router.push("/admin/login");
                    return;
                } else if (!isAdminRoute && !pathname.startsWith("/login") && pathname !== "/") {
                    router.push("/login");
                    return;
                }
                return;
            ...
            try {
                ...
                if (response?.success) {
                    ...
                    // Handle redirection based on route and token type
                    if (isAdminRoute) {
    ...
    const AuthRedirect = ({ children })=>{
        ...
        const isAdminRoute = pathname?.startsWith("/admin");
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
            "InnerClientProviders.AuthRedirect.useEffect": ()=>{
                if (isAdminRoute && !adminToken) {
                    router.replace("/admin/login");
                } else if (!isAdminRoute && !token && pathname !== "/login" && pathname !== "/") {
    ...
    _s1(AuthRedirect, "OD7bBpZva5O2jO+Puf00hKivP7c=");
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthRedirect, {
        children: children
    }, void 0, false, {
        fileName: "[project]/src/providers/ClientProviders.js",
        lineNumber: 157,
...
//# sourceMappingURL=src_5f55a6a3._.js.map