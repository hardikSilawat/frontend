...
function DSAProgressTracker() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DSAProgressTracker.useEffect": ()=>{
            const fetchProgress = {
                "DSAProgressTracker.useEffect.fetchProgress": async ()=>{
                    try {
                        setLoading(true);
                        const [allResponse, completedResponse] = await Promise.all([
                            fetch('/api/subtopics?limit=1000').then({
                                "DSAProgressTracker.useEffect.fetchProgress": (res)=>res.json()
                            }["DSAProgressTracker.useEffect.fetchProgress"]),
                            fetch('/api/subtopics/completed').then({
                                "DSAProgressTracker.useEffect.fetchProgress": (res)=>res.json()
                            }["DSAProgressTracker.useEffect.fetchProgress"])
                        ]);
                        if (allResponse.success && completedResponse.success) {
                            const allSubtopics = allResponse.data.subtopics || [];
                            const completedSubtopics = completedResponse.data.subtopics || [];
                            const easy = allSubtopics.filter({
                                "DSAProgressTracker.useEffect.fetchProgress.easy": (s)=>s.difficulty === 'easy'
                            }["DSAProgressTracker.useEffect.fetchProgress.easy"]);
                            const medium = allSubtopics.filter({
                                "DSAProgressTracker.useEffect.fetchProgress.medium": (s)=>s.difficulty === 'medium'
                            }["DSAProgressTracker.useEffect.fetchProgress.medium"]);
                            const tough = allSubtopics.filter({
                                "DSAProgressTracker.useEffect.fetchProgress.tough": (s)=>s.difficulty === 'tough'
                            }["DSAProgressTracker.useEffect.fetchProgress.tough"]);
                            const completedEasy = completedSubtopics.filter({
                                "DSAProgressTracker.useEffect.fetchProgress.completedEasy": (s)=>s.difficulty === 'easy'
                            }["DSAProgressTracker.useEffect.fetchProgress.completedEasy"]);
                            const completedMedium = completedSubtopics.filter({
                                "DSAProgressTracker.useEffect.fetchProgress.completedMedium": (s)=>s.difficulty === 'medium'
                            }["DSAProgressTracker.useEffect.fetchProgress.completedMedium"]);
                            const completedTough = completedSubtopics.filter({
                                "DSAProgressTracker.useEffect.fetchProgress.completedTough": (s)=>s.difficulty === 'tough'
                            }["DSAProgressTracker.useEffect.fetchProgress.completedTough"]);
                            setProgress({
                                total: allSubtopics.length,
                                completed: completedSubtopics.length,
                                percentage: allSubtopics.length > 0 ? Math.round(completedSubtopics.length / allSubtopics.length * 100) : 0,
                                easy: {
                                    total: easy.length,
                                    completed: completedEasy.length
                                },
                                medium: {
                                    total: medium.length,
                                    completed: completedMedium.length
                                },
                                tough: {
                                    total: tough.length,
                                    completed: completedTough.length
                                }
                            });
                        }
                    } catch (error) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Paper$2f$Paper$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Paper$3e$__["Paper"], {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ProgressItem, {
                label: "Medium",
                value: progress.medium.completed,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ProgressItem, {
                label: "Tough",
                value: progress.tough.completed,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                ...
                alignItems: "center",
                justifyContent: "center",
                bgcolor: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$system$2f$esm$2f$colorManipulator$2f$colorManipulator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["alpha"])(theme.palette.primary.main, 0.08),
                p: 2,
                borderRadius: 2,
                children: [
...
_s(DSAProgressTracker, "nGdFuaggyslWtZrpNRZfCq6OSk8=", false, function() {
    return [
...
"[project]/node_modules/@mui/icons-material/esm/EmojiEvents.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=_a79d2c63._.js.map