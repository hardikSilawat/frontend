...
"[project]/src/components/Admin/DynamicForm/index.js [app-client] (ecmascript) <export default as DynamicForm>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "DynamicForm",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Admin$2f$DynamicForm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Admin$2f$DynamicForm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/Admin/DynamicForm/index.js [app-client] (ecmascript)");
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Admin$2f$DynamicForm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__DynamicForm$3e$__ = __turbopack_context__.i("[project]/src/components/Admin/DynamicForm/index.js [app-client] (ecmascript) <export default as DynamicForm>");
...
function TopicsPage() {
    ...
    const [topicToUpdate, setTopicToUpdate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const fetchTopics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TopicsPage.useCallback[fetchTopics]": async ()=>{
            try {
                setState({
                    "TopicsPage.useCallback[fetchTopics]": (prev)=>({
                            ...prev,
                            loading: true
                        })
                }["TopicsPage.useCallback[fetchTopics]"]);
                ...
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiHandler$2f$page$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(`/topics?${params.toString()}`);
                if (response.success) {
                    setState({
                        "TopicsPage.useCallback[fetchTopics]": (prev)=>({
                                ...prev,
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.response?.data?.message || "Failed to fetch topics");
            }
        }
    }["TopicsPage.useCallback[fetchTopics]"], [
        state.page,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TopicsPage.useEffect": ()=>{
            const timer = setTimeout({
                "TopicsPage.useEffect.timer": ()=>{
                    fetchTopics();
                }
            }["TopicsPage.useEffect.timer"], 300);
            return ({
                "TopicsPage.useEffect": ()=>clearTimeout(timer)
            })["TopicsPage.useEffect"];
        }
    }["TopicsPage.useEffect"], [
        fetchTopics
    ...
    const handleDelete = async (topic)=>{
        try {
            await confirm({
                ...
                onConfirm: async ()=>{
                    try {
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiHandler$2f$page$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].delete(`/topics/${topic._id}`);
                        if (response.success) {
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Topic deleted successfully");
                            fetchTopics();
                        } else {
            ...
            if (error !== "cancelled") {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.response?.data?.message || "Failed to delete topic");
            }
        }
    };
    const handleAdd = ()=>{
    ...
    const handleSubmitTopic = async (data)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(successMessage);
            fetchTopics();
            handleCloseForm();
        } catch (error) {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Dialog$2f$Dialog$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Dialog$3e$__["Dialog"], {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$DialogContent$2f$DialogContent$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__DialogContent$3e$__["DialogContent"], {
                            dividers: true,
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Admin$2f$DynamicForm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__DynamicForm$3e$__["DynamicForm"], {
                                fields: formFields,
...
_s(TopicsPage, "2TltFdm4E8wx00CaduDqN7PX2mY=", false, function() {
    return [
...
_c = TopicsPage;
var _c;
__turbopack_context__.k.register(_c, "TopicsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_9f64ba06._.js.map