...
function UsersPage() {
    ...
    const [userToUpdate, setUserToUpdate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const fetchUsers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UsersPage.useCallback[fetchUsers]": async (signal)=>{
            try {
                setState({
                    "UsersPage.useCallback[fetchUsers]": (prev)=>({
                            ...prev,
                            loading: true
                        })
                ...
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiHandler$2f$page$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(`/auth/admin/users?${params.toString()}`, {
                    signal
                });
                if (response.success) {
                    setState({
                ...
                if (error.name !== "AbortError") {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.response?.data?.message || "Failed to fetch users");
                }
            }
        }
    }["UsersPage.useCallback[fetchUsers]"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UsersPage.useEffect": ()=>{
            ...
            }["UsersPage.useEffect.timer"], 300); // Reduced debounce time for better UX
            return ({
                "UsersPage.useEffect": ()=>{
                    clearTimeout(timer);
                    if (controllerRef.current) {
    ...
    const handleDelete = async (user)=>{
        try {
            await confirm({
                ...
                onConfirm: async ()=>{
                    try {
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiHandler$2f$page$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].delete(`/auth/admin/delete-user/${user._id}`);
                        if (response.success) {
                            fetchUsers();
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("User deleted successfully");
                        } else {
            ...
            if (error !== "cancelled") {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.response?.data?.message || "Failed to delete user");
            }
        }
    };
    const handleAdd = ()=>{
    ...
    const handleSubmitUser = async (data)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(response.message || successMessage);
            fetchUsers();
            handleCloseForm();
        } catch (error) {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Button$2f$Button$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Button$3e$__["Button"], {
                            ...
                            sx: {
                                ...
                                background: `linear-gradient(45deg, ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$theme$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].palette.primary.main} 0%, #3cb815 100%)`,
                                transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
                                position: "relative",
                                overflow: "hidden",
                                "&:hover": {
...
_s(UsersPage, "n3yyoKm7BTBG2wwJxQjTy3owhkM=", false, function() {
    return [
...
//# sourceMappingURL=src_150dfb72._.js.map