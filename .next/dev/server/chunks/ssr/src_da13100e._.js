module.exports = [
"[project]/src/services/dsaService.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const getTopics = async ()=>{
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiHandler$2f$page$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get('/topics');
    } catch (error) {
...
const getTopic = async (id)=>{
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiHandler$2f$page$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get(`/topics/${id}`);
    } catch (error) {
...
const getSubtopics = async (topicId)=>{
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiHandler$2f$page$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get(`/subtopics/topic/${topicId}`);
    } catch (error) {
...
const getSubtopic = async (id)=>{
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiHandler$2f$page$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get(`/subtopics/${id}`);
    } catch (error) {
...
const getCompletedProblems = async ()=>{
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiHandler$2f$page$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get('/subtopics/completed');
    } catch (error) {
...
const markAsCompleted = async (subtopicId)=>{
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiHandler$2f$page$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post(`/subtopics/${subtopicId}/complete`);
    } catch (error) {
...
const removeFromCompleted = async (subtopicId)=>{
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiHandler$2f$page$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].delete(`/subtopics/${subtopicId}/complete`);
    } catch (error) {
...
const ChapterDetail = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(async ()=>{}, {
    loadableGenerated: {
        modules: [
...
function Dashboard() {
    ...
    const [subtopics, setSubtopics] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
        ...
        const fetchData = async ()=>{
            try {
                ...
                const [topicsData, completedData] = await Promise.all([
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$dsaService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTopics"])(),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$dsaService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCompletedProblems"])()
                ]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const fetchSubtopics = async ()=>{
            try {
                setIsLoading(true);
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$dsaService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSubtopics"])(selectedChapter.id);
    ...
    const handleToggleComplete = async (chapterId, problemId)=>{
        try {
            ...
            if (isCompleted) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$dsaService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["removeFromCompleted"])(problemId);
            } else {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$dsaService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["markAsCompleted"])(problemId);
            }
            // Update local state
            setProgress((prev)=>({
                    ...prev,
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Grid$2f$Grid$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Grid$3e$__["Grid"], {
                            ...
                            children: isLoading && !chapters.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                                ...
                                lineNumber: 188,
                                columnNumber: 15
                            }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(DSAChapterList, {
                                chapters: chapters,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Grid$2f$Grid$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Grid$3e$__["Grid"], {
                            ...
                            children: isLoading && selectedChapter ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Box$3e$__["Box"], {
                                ...
                                lineNumber: 204,
                                columnNumber: 15
                            }, this) : selectedChapter ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(ChapterDetail, {
...
//# sourceMappingURL=src_da13100e._.js.map