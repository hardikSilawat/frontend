module.exports = [
"[project]/src/services/dsaService.js [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$dsaService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/dsaService.js [app-ssr] (ecmascript)");
"use client";
;
;
;
...
const ChapterDetail = ({ chapter, subtopics = [], onUpdate })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchCompletedSubtopics = async ()=>{
            try {
                const response = await api.get("/subtopics/completed");
    ...
    const handleToggleComplete = async ()=>{
        ...
        try {
            ...
            setError(null);
            if (isCompleted) {
                await api.delete(`/subtopics/${currentSubtopic._id}/complete`);
                ...
                await api.post(`/subtopics/${currentSubtopic._id}/complete`);
...
function DSAPage() {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    // Fetch all topics with subtopics
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchData = async ()=>{
            try {
                ...
                setCompletedSubtopicIds(completedRes.data?.map((item)=>item._id) || []);
...
//# sourceMappingURL=src_93ca0dc1._.js.map