...
function SubtopicsPage() {
    ...
    const fetchSubtopics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (signal)=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiHandler$2f$page$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get(`/subtopic?${params.toString()}`, {
                signal
            });
            if (response.success) {
                setState((prev)=>({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchTopics = async ()=>{
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiHandler$2f$page$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get("/topic?limit=1000");
                if (response.success) {
                    setState((prev)=>({
                            ...prev,
    ...
    const handleDelete = async (subtopic)=>{
        try {
            await confirm({
                ...
                onConfirm: async ()=>{
                    try {
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$apiHandler$2f$page$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].delete(`/subtopic/${subtopic._id}`);
                        if (response.success) {
                            fetchSubtopics();
    ...
    const handleSubmitSubtopic = async (data)=>{
        ...
        const endpoint = isUpdate ? `/subtopic/${subtopicToUpdate._id}` : "/subtopic";
...
//# sourceMappingURL=src_d05db5be._.js.map